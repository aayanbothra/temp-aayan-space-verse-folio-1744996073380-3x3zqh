...
const editingProjects: EditingProject[] = [
  {
    ...
    thumbnail: "https://images.unsplash.com/photo-1559767949-0faa5c7e9992?q=80&w=2070&auto=format&fit=crop",
          ...
          {editingProjects.map((project, index) => (
            ...
            >
              <div className="h-48 overflow-hidden relative">
                ...
                />
                <div className="absolute inset-0 bg-space-blue-dark/50 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity duration-300">
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-3">
                  <span className="text-xs px-2 py-1 rounded-full bg-space-purple/20 text-space-purple-light">
                    {project.tool}
                  </span>
                  <span className="text-xs px-2 py-1 rounded-full bg-space-purple/20 text-space-purple-light">
                    {project.duration}
            ...
            <div className="relative w-full max-w-4xl" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="glass-panel p-4 mt-4">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="text-sm px-2 py-1 rounded-full bg-space-purple/20 text-space-purple-light">
